...
As dataset we used the Human Genome (as described in [this benchmark page](https://bioinf.shenwei.me/seqkit/benchmark/)).
...
| `seqkit stats $FILE` | 116.693 ± 0.236 | 116.512 | 116.960 | 4.26 ± 0.05 |
...
| Command | Mean [s] | Min [s] | Max [s] | Relative |
|:---|---:|---:|---:|---:|
| `seqfu stats Gastrointestinal_tract.nuc.fsa` | 6.885 ± 0.307 | 6.602 | 7.211 | 1.82 ± 0.09 |
| `seqkit stats Gastrointestinal_tract.nuc.fsa` | 3.793 ± 0.082 | 3.699 | 3.854 | 1.00 |
| `seqkit stats --all Gastrointestinal_tract.nuc.fsa` | 7.667 ± 0.081 | 7.583 | 7.746 | 2.02 ± 0.05 |
| `n50 -x Gastrointestinal_tract.nuc.fsa` | 76.377 ± 1.990 | 74.891 | 78.638 | 20.14 ± 0.68 |
