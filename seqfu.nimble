...
# Dependencies
requires "nim >= 2.0", "regex >= 0.23", "checksums", "docopt#v0.7.1", "terminaltables", "readfq#head", "iterutils", "argparse",  "colorize", "zip", "datamancer >= 0.3", "illwill#v0.2.0", "malebolgia >= 1.3.2"
